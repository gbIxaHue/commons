...
import ru.dev.gbixahue.library.predictable.LaunchFactory
...
abstract class BaseApplication: Application() {
  ...
  override fun attachBaseContext(base: Context) {
    prefRepo = PreferenceRepository(base.getSharedPreferences(getPreferenceName(base),
        Context.MODE_PRIVATE), GsonConverter.instance)
