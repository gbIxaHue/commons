...
import ru.dev.gbixahue.library.arch.routing.cicerone.result.ResultListener
...
class Router: BaseRouter() {
	...
	private val resultListeners: SparseArray<ResultListener> = SparseArray()
	 ...
	 */
	@JvmOverloads
	fun navigateTo(screenKey: Screen, data: Any? = null) {
	 ...
	 */
	@JvmOverloads
	fun newScreenChain(screenKey: Screen, data: Any? = null) {
	 ...
	 */
	@JvmOverloads
	fun newRootScreen(screenKey: Screen, data: Any? = null) {
	 ...
	 */
	@JvmOverloads
	fun replaceScreen(screenKey: Screen, data: Any? = null) {
