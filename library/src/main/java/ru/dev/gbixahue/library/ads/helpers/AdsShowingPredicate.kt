...
import ru.dev.gbixahue.library.predictable.Predicate
...
import ru.dev.gbixahue.library.utils.getRandom
...
class AdsShowingPredicate(
  ...
  override fun adsClicked() {
    val hidePrior = incrementTime(Calendar.HOUR, System.currentTimeMillis(), getRandom(3, 6))
